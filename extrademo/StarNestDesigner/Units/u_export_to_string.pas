...
begin
  packedParams := ScreenDemo.Stars.SaveParamsToString;

  // format the packed string for ease integration into a fpc/lazarus program
  i := 1;
  formated := 'const STARNEST_'+UpperCase(FormMain.GetLastSelectedPresetNameWithoutSpace)+' ='+LineEnding;
...
begin
  formated := '[code=pascal]'+
               ...
               ScreenDemo.Stars.SaveParamsToString+
               '[/code]';
