...
begin
  ...
  t.AddText('{'#10+
            ...
            '  Usage:'#10+
            '    - call TDecorManager.LoadTexture() when you construct your texture atlas.'#10+
            ...
            'type'#10#10+
            '{ TDecorManager }'#10+#10+
            'TDecorManager = class(TOGLCDecorManager)'#10+
            '  class procedure LoadTexture(aAtlas: TAtlas); override;'#10+
            '  procedure LoadLevelIndex(aIndex: integer);'#10+
    ...
    try
      ...
      if sl.Size > 0 then begin
        ...
        for j:=0 to sl.Size-1 do begin
          s := s+'  ''S'+j.ToString+'|'+sl.Mutable[j]^.ExportToPascalString;
  ...
  // method for class TDecorContainer.LoadTexture()
  t.AddText('{ TDecorManager }'+#10+#10);
  t.AddText('class procedure TDecorManager.LoadTexture(aAtlas: TOGLCTextureAtlas);'#10+
  ...
  t.AddText('procedure TDecorManager.LoadLevel(aLevelIndex: integer);'#10+
            'begin'#10+
            '  case aIndex of');
  ...
  t.AddText('function TDecorManager.GetWorldArea: TRectF;'#10+
            'begin'#10+
