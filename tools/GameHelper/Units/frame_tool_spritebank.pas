...
begin
  ...
  if Surfaces.UseTexture then
    t.Add('    - call '+GetClassName+'.LoadTexture() when you construct your texture atlas.');
  ...
  case GetClassType of
    ...
    else raise exception.create('forgot to implement '+GetClassType);
  end;
  t.Add(s);
